...
if(DNSSD_name)
  list(APPEND FIND_PACKAGES_DEFINES SERVUS_USE_DNSSD)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND SERVUS_DEPENDENT_LIBRARIES DNSSD)
  endif()
...
if(avahi-client_name)
  list(APPEND FIND_PACKAGES_DEFINES SERVUS_USE_AVAHI_CLIENT)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND SERVUS_DEPENDENT_LIBRARIES avahi-client)
  endif()
